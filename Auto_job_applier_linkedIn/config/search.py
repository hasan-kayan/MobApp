...
search_terms = ["Software Engineer", "Software Developer", "Python Developer", "React Developer", "JavaScript Developer", "Front End Developer", "Full Stack Developer", "Web Developer", "Nodejs Developer"]
